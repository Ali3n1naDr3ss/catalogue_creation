...
#        field = 'COSMOS'
    ...
    if cutband != 'none':
        ...
        print(fi, maskFile, imagedata)

        # check xy!
        maskFile = f'/raid/scratch/hullyott/cataloguing/DepthsTestDir/data/masks/COSMOS/{maskFile}'
        print(maskFile)
        print(maskFile[0])
...
def combine_cats(field, detFilt, catalogueTypes, apDiametersAS = [1.8, 2.0, 3.0, 4.0, 5.0], imageDir = '/raid/scratch/data/', requiredSpit = ['2.8', '2.8', '2.8', '2.8', '2.8'], IRACapDiametersAS = [2.8, 3.8, 5.8, 9.8, 11.6]):
    ...
    ############################################################
    catDir = '/raid/scratch/hullyott/cataloguing/DepthsTestDir/data/catalogues/'
