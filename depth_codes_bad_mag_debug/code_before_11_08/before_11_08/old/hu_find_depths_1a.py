...
for ff, fieldName in enumerate(fields):
    ...
    outputDir = '../depths/{0}/'.format('COSMOS_test') # HOLLY 17/07/25 doing some tests
    ...
    if output_img_name == 'none':
        ...
        detections_fig_full('/raid/scratch/data/COSMOS/UVISTA_J_DR6.fits', ['J','JH'], outputCatalogues) # warning: testing on J, JH only        
    else:
