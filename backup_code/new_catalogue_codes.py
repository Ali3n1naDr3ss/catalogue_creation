...
def flux_errors(inputTableFile, fieldName, dataDir = '/raid/scratch/data/', overwrite = False, minError = 5.0, psfType = 'peak', minErrorIRAC = 5.0, IRACapertureAS = 2.8, depthType = 'grid', depths = [], provFilters = [], outputType = 'fits', verbose = False, inputDirProvided = False, removeCoadds = True, checkFile = 'none', microJyYes = True, xyName = ['X_IMAGE', 'Y_IMAGE'], badFilters = np.array(['NB118']), xmmflag = ['NONE'], countsKey = 'flux_'):
