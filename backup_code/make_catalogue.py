...
Modified: from analyse_image.py on Tue 26th Nov 2019

"""

###################### Import useful modules #########################
import numpy as np
from new_catalogue_codes import *

#catName = '/users/bowlerr/currentprojects/stacking/fullcats/XMM_MUV_all_HSCDR2_2.0as_cgs.fits'
#set_negativeflux_zero(catName)
#exit()
...
######################### Set-up ####################################
# set the detection filter!
detectionFilters = ['JH', 'HKs']
# keep this as J
...
#reqFilters = ['ch1servs', 'ch2servs'] #, 'HSC-R_DR3', 'HSC-I', 'HSC-Z_DR3', 'HSC-Y', 'HSC-NB0816_DR3', 'HSC-NB0921_DR3']
#reqFilters = ['u', 'g', 'r', 'i', 'HSC-G', 'HSC-R', 'HSC-I', 'HSC-Z']
...
# or you can set filters individually like this = ['ch1servs', 'ch2servs']

# required aperture diameter
#reqMag = '2.0' # or 'MAG_AUTO' etc.

# enter the prefered queue to run on
queue = 'none'  #'none'
...
# these are the apertures that are run in SE
...
requiredCats =  np.array(['2.0', '3.0', 'MAG_AUTO'])#, 'FLUX_RADIUS'])
